...
## Signal board · latest signed package 2026-09-22

| Signal | Current value |
| --- | ---: |
| Public article records at this export | **5131** |
| Published cross-source story groups at this export | **1833** |
| Articles added in this daily delta | 0 |
| Stories added in this daily delta | 0 |
| Records currently stored in the pipeline | 27504 |
| Files in this daily package | 2 |
| Signed daily deltas after baseline | 50 |
| Baseline article records / story groups | 321 / 107 |
| Baseline distinct media sources | 16 |

**Latest package:** `daily/2026-09-22/`  
**Generated:** `2026-09-22T00:15:56.172Z`  
...
At a conservative **12 minutes** to locate, open, normalise, attribute and preserve one article, the **5131 currently public records in this latest signed export** represent at least **1026.2 hours** of manual reconstruction work — about **27.4 full-time research weeks** — before cross-source matching, revision tracking or analytical enrichment.
