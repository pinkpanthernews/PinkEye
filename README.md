...
## Signal board · latest signed package 2026-09-04

| Signal | Current value |
| --- | ---: |
| Public article records at this export | **3947** |
| Published cross-source story groups at this export | **1407** |
| Articles added in this daily delta | 2 |
| Stories added in this daily delta | 1 |
| Records currently stored in the pipeline | 18577 |
| Files in this daily package | 13 |
| Signed daily deltas after baseline | 32 |
| Baseline article records / story groups | 321 / 107 |
| Baseline distinct media sources | 16 |

**Latest package:** `daily/2026-09-04/`  
**Generated:** `2026-09-04T00:16:10.897Z`  
**Integrity:** `signed` Ed25519 signature · package digest `ccdb4b0129702ca5ed32c1f6dd451e4930ea6af31838d3530478fea6ff51a088`  
...
At a conservative **12 minutes** to locate, open, normalise, attribute and preserve one article, the **3947 currently public records in this latest signed export** represent at least **789.4 hours** of manual reconstruction work — about **21.1 full-time research weeks** — before cross-source matching, revision tracking or analytical enrichment.
