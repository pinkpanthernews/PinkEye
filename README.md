...
## Signal board · latest signed package 2026-09-20

| Signal | Current value |
| --- | ---: |
| Public article records at this export | **5004** |
| Published cross-source story groups at this export | **1788** |
| Articles added in this daily delta | 5 |
| Stories added in this daily delta | 1 |
| Records currently stored in the pipeline | 26636 |
| Files in this daily package | 24 |
| Signed daily deltas after baseline | 48 |
| Baseline article records / story groups | 321 / 107 |
| Baseline distinct media sources | 16 |

**Latest package:** `daily/2026-09-20/`  
**Generated:** `2026-09-20T00:15:56.564Z`  
**Integrity:** `signed` Ed25519 signature · package digest `0df6cc1a033acd338646167cd20b00db37dd84dd181eb37450ee9a5a17728a96`  
...
At a conservative **12 minutes** to locate, open, normalise, attribute and preserve one article, the **5004 currently public records in this latest signed export** represent at least **1000.8 hours** of manual reconstruction work — about **26.7 full-time research weeks** — before cross-source matching, revision tracking or analytical enrichment.
