...
## Signal board · latest signed package 2026-09-23

| Signal | Current value |
| --- | ---: |
| Public article records at this export | **5190** |
| Published cross-source story groups at this export | **1852** |
| Articles added in this daily delta | 0 |
| Stories added in this daily delta | 0 |
| Records currently stored in the pipeline | 28031 |
| Files in this daily package | 2 |
| Signed daily deltas after baseline | 51 |
| Baseline article records / story groups | 321 / 107 |
| Baseline distinct media sources | 16 |

**Latest package:** `daily/2026-09-23/`  
**Generated:** `2026-09-23T00:16:56.677Z`  
...
At a conservative **12 minutes** to locate, open, normalise, attribute and preserve one article, the **5190 currently public records in this latest signed export** represent at least **1038.0 hours** of manual reconstruction work — about **27.7 full-time research weeks** — before cross-source matching, revision tracking or analytical enrichment.
