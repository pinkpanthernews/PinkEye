...
## Signal board · latest signed package 2026-09-21

| Signal | Current value |
| --- | ---: |
| Public article records at this export | **5055** |
| Published cross-source story groups at this export | **1804** |
| Articles added in this daily delta | 2 |
| Stories added in this daily delta | 1 |
| Records currently stored in the pipeline | 26986 |
| Files in this daily package | 14 |
| Signed daily deltas after baseline | 49 |
| Baseline article records / story groups | 321 / 107 |
| Baseline distinct media sources | 16 |

**Latest package:** `daily/2026-09-21/`  
**Generated:** `2026-09-21T00:17:02.712Z`  
**Integrity:** `signed` Ed25519 signature · package digest `dbb3b9a62a46b8bb62cce00a87a43db8f558b096f342127b63d8b5e78cc7de1c`  
...
At a conservative **12 minutes** to locate, open, normalise, attribute and preserve one article, the **5055 currently public records in this latest signed export** represent at least **1011.0 hours** of manual reconstruction work — about **27.0 full-time research weeks** — before cross-source matching, revision tracking or analytical enrichment.
