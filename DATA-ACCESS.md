...
**Documentation generated:** `2026-09-01T10:01:09Z`  
**Current baseline:** `baseline/2026-08-02/` with **321** public article records.  
**Signed deltas available:** **24**, latest `daily/2026-08-27/`.
...
Do not redistribute raw text, images, packages or derived raw-text datasets. Do not remove origin markers, source attribution, hashes or policy fields. Do not present the corpus or derived work as independently collected. Automated labels are analytical model output, not determinations of truth, bias, legality or liability.
